...
print("input_ids:", inputs["input_ids"].shape, inputs["input_ids"].dtype, inputs["input_ids"].device)
print("attention_mask:", inputs["attention_mask"].shape, inputs["attention_mask"].dtype, inputs["attention_mask"].device)
print("pixel_values:", inputs["pixel_values"].shape, inputs["pixel_values"].dtype, inputs["pixel_values"].device)
